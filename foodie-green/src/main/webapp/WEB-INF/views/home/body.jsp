...
-->
			...
			<div class="at-twitter">
				<a href="//twitter.com/hendrysadrak" target="_blank">@hendrysadrak</a>
			</div>
		...
		<div id="body"
			style="border-color: black; border-style: solid; border-width: 10px; height: 800px"></div>
		<div id="body"
			style="border-color: black; border-style: solid; border-width: 10px; height: 800px"></div>
		<div id="body"
			style="border-color: black; border-style: solid; border-width: 10px; height: 800px"></div>
