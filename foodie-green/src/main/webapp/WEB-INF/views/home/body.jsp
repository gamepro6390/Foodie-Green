...
<body>
	...
	<!-- main 부분 -->
	<main>
		<div id="body" style="border-color: black; border-style: solid; border-width:10px; height:800px">
<!-- 			<div class="app">
 ...
 -->
		...
		<div id="body" style="border-color: black; border-style: solid; border-width:10px; height:800px"></div>
		<div id="body" style="border-color: black; border-style: solid; border-width:10px; height:800px"></div>
		<div id="body" style="border-color: black; border-style: solid; border-width:10px; height:800px"></div>
	</main>
</body>
